    ...
    return (
        <Modal maxWidth={maxWidth} show={IsOpen} onClose={closeModal}>
            <div className='w-full p-4'>
                ...
                <form onSubmit={submitSetWorkSpaceSetting} className="">
                    <div className="mb-4 w-64">
                        <label htmlFor="goodLists" className="block mb-2 text-sm font-medium text-gray-900">Выберите список товаров</label>
                        <select
