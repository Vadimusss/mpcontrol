...
export default function DeleteProductListConfirmModal({ shopId, productList, maxWidth, IsOpen, closeModal }) {

    const handleDelete = (e) => {
        e.preventDefault();
        Inertia.delete(route('shops.workspaces.destroy', [shopId, productList.id]), {
            preserveScroll: true,
        ...
        <Modal maxWidth={maxWidth} show={IsOpen} onClose={closeModal}>
            <div className='max-w-fit p-4'>
                <h2 className="text-lg font-medium text-gray-900">
                    Удалить список товаров {productList.name}?
                </h2>
